...
#ifndef SKID_STEER_CONTROLLER__SKID_STEER_HPP_
#define SKID_STEER_CONTROLLER__SKID_STEER_HPP_
...
class SkidSteerControllerHardware : public hardware_interface::SystemInterface{
...
private:
    ...
    std::string back_left_wheel_joint = "";
    std::string front_right_wheel_joint = "";
    std::string back_right_wheel_joint = "";
